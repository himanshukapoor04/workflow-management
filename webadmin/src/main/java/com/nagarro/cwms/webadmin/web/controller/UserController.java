...
public class UserController {
	...
	public ModelAndView approveStep(@PathVariable long workflowId, @PathVariable long workflowInstanceId, @PathVariable long stepInstanceId, @PathVariable long userId) {
		ModelAndView modelAndView = new ModelAndView();
